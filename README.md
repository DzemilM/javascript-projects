...
Practice projects built with plain HTML, CSS and JavaScript - no frameworks,
no build steps. Each folder is self-contained: open its `index.html` in a
browser and it runs.
...
| [Task Tracker](./Task%20Tracker) | Add, complete and delete tasks; completed ones sink to the bottom | https://roadmap.sh/projects/task-tracker |
